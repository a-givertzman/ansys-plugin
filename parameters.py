...
class Parameters:
    def __init__(self,
        ...
        self.__rawParams = rawParams
    ''''''
    def inputP(self):
        keys = {}
        for values in self.__rawParams['inValues']:
            index = 0
            for key in self.__rawParams['inKeys']:
                keys[key] = values[index]
                index += 1
        return keys
    ''''''
    def outputP():
        return self.__rawParams['outKeys']
